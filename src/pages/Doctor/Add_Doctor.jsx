...
export default function Add_Doctor() {
  ...
  const handleSubmit = () => {
    ...
    axios.post('http://127.0.0.1:8000/api/doctor/api/doctors/', formData)
      .then((response) => {
          ...
          <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
            ...
            <div className="flex flex-col items-stretch w-6/12 ml-5 max-md:w-full max-md:ml-0">
              <div className="items-stretch flex grow flex-col py-7 max-md:max-w-full max-md:mt-10">
                ...
                <input className="text-gray-500  text-base border-transparent font-medium leading-4 whitespace-nowrap bg-slate-100 justify-center mt-3 pl-4 pr-16 py-4 rounded-md items-start max-md:max-w-full max-md:pr-5" type='text' name='phone number' value={formData.phonenumber}
                    onChange={handleChange}
                ...
                <div className="">
                  <input className="items-stretch h-[53px] w-[520px] border-transparent   bg-slate-100 flex justify-between gap-5 mt-3 px-5 py-3 rounded-md max-md:max-w-full max-md:flex-wrap max-md:pr-5" type='dob' name='date' value={formData.dob}
                    onChange={handleChange}
        ...
        {activeStep === 1 && (
          ...
          <div className="max-md:max-w-full">
            <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
              <div className="flex flex-col items-stretch w-6/12 max-md:w-full max-md:ml-0">
                <div className="items-stretch flex grow flex-col pt-7 max-md:max-w-full max-md:mt-10">
                  ...
                  <div>
                  <select className="justify-between border-transparent  w-[500px] items-stretch bg-slate-100 flex gap-5 mt-2 px-3.5 py-4 rounded-md max-md:max-w-full max-md:flex-wrap" type='select' name='educational qualification'  value={formData.educationalqualification}
                onChange={handleChange}
            ...
            <option className='text-gray-500 text-base font-medium leading-4' value="Teacher">Teacher</option>
                  ...
                  <div >
                    <input className="justify-between  border-transparent  w-[500px] items-stretch bg-slate-100 flex gap-5 mt-2 px-3.5 py-4 rounded-md max-md:max-w-full max-md:flex-wrap" type='text' name='working details'  value={formData.workingdetails}
                onChange={handleChange}
        ...
        {activeStep === 2 && (
          ...
          <div >
            <div className="text-gray-500 text-base font-medium leading-4 grow shrink basis-auto">
              ...
              <select className="justify-between border-transparent items-stretch bg-slate-100 flex w-[613px] max-w-full gap-5 mt-2 pl-5 pr-20 py-4 rounded-md max-md:flex-wrap max-md:pr-5" type='select' name='identity proof'  value={formData.identityproof}
                onChange={handleChange}
